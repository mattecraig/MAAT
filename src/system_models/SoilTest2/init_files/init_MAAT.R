################################
#
# MAAT SoilTest2 model - initialisation script
# 
...
# This script initialises the SoilTest2 version of MAAT
...
init_static <- list(
  fnames = list( SoilTest2 = fnames.static),
  pars   = list( SoilTest2 = pars.static),
  env    = list( SoilTest2 = env.static)
)

init_dynamic <- list(
  fnames    = list( SoilTest2 = fnames.var),
  pars      = list( SoilTest2 = pars.var),
  pars_proc = list( SoilTest2 = pars_proc.var),
  pars_eval = list( SoilTest2 = pars_eval.var),
  env       = list( SoilTest2 = env.var)
)
