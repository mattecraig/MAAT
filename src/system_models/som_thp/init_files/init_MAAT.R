################################
#
# MAAT som_thp model - initialisation script
# 
...
# This script initialises the som_thp version of MAAT
...
init_static <- list(
  fnames = list( som_thp = fnames.static),
  pars   = list( som_thp = pars.static),
  env    = list( som_thp = env.static)
)

init_dynamic <- list(
  fnames    = list( som_thp = fnames.var),
  pars      = list( som_thp = pars.var),
  pars_proc = list( som_thp = pars_proc.var),
  pars_eval = list( som_thp = pars_eval.var),
  env       = list( som_thp = env.var)
)
